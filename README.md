...
Step 3 — Create CA001 in Report-only → test sign-in → switch to On
Step 4 — Create Canada Named Location
Step 5 — Create CA002 in Report-only → validate logs → switch to On
...
- CA002 created — geo-restriction policy in Report-only mode ✅
